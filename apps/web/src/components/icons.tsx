...
function Base({ size = 26, color = 'currentColor', children }: { size?: number; color?: string; children: ReactNode }) {
  return (
...
export function ChevronDownIcon({ color = 'currentColor', size = 18 }: { color?: string; size?: number }) {
  return (
